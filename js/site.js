...
<section class="extra-section section" id="teacher"><div class="container">
${extraHeading('Meet the teaching team.','शिक्षण टीम से मिलें।','One founder profile and two clearly marked demo profiles. Replace sample names, details and AI photos before publishing.','एक संस्थापक प्रोफाइल और दो स्पष्ट डेमो प्रोफाइल। प्रकाशित करने से पहले नमूना नाम, जानकारी और AI फोटो बदलें।')}
<div class="teacher-grid">
<article class="teacher-card"><div class="teacher-placeholder"><span aria-hidden="true">SKS</span><p>${extraCopy('Actual photo to be added','वास्तविक फोटो यहाँ जोड़ी जाएगी')}</p></div><div class="teacher-card-body"><p class="extra-kicker">${extraCopy('Founder profile','संस्थापक प्रोफाइल')}</p><h3 class="teacher-name">Saurabh Kumar Singh</h3><p>${extraCopy('Founder & Mentor · Set to Success','संस्थापक एवं मार्गदर्शक · Set to Success')}</p><dl class="teacher-facts"><div><dt>${extraCopy('Teaching focus','शिक्षण का केंद्र')}</dt><dd>${extraCopy('Mathematics · clear concepts and practice','गणित · स्पष्ट अवधारणाएँ और अभ्यास')}</dd></div><div><dt>${extraCopy('Qualification & experience','योग्यता और अनुभव')}</dt><dd>${extraCopy('Verified details coming soon','सत्यापित जानकारी जल्द आएगी')}</dd></div></dl><a class="extra-link" href="#admission">${extraCopy('Discuss learning needs →','पढ़ाई की जरूरतों पर बात करें →')}</a></div></article>
<article class="teacher-card teacher-card-demo"><div class="teacher-photo"><img src="img/demo-teacher-arjun.webp" alt="AI-generated demo portrait for a sample mathematics teacher profile" loading="lazy" width="1024" height="1536"><span>${extraCopy('AI demo photo','AI डेमो फोटो')}</span></div><div class="teacher-card-body"><p class="extra-kicker">${extraCopy('Fictional demo profile','काल्पनिक डेमो प्रोफाइल')}</p><h3 class="teacher-name">Arjun Kumar</h3><p>${extraCopy('Mathematics Faculty · Demo','गणित शिक्षक · डेमो')}</p><dl class="teacher-facts"><div><dt>${extraCopy('Teaching focus','शिक्षण का केंद्र')}</dt><dd>${extraCopy('Classes 8–10 · concept building','कक्षा 8–10 · अवधारणा निर्माण')}</dd></div><div><dt>${extraCopy('Details','जानकारी')}</dt><dd>${extraCopy('Sample only · verification pending','केवल नमूना · सत्यापन बाकी')}</dd></div></dl><a class="extra-link" href="#admission">${extraCopy('Ask about classes →','कक्षाओं के बारे में पूछें →')}</a></div></article>
<article class="teacher-card teacher-card-demo"><div class="teacher-photo"><img src="img/demo-teacher-meera.webp" alt="AI-generated demo portrait for a sample academic-support teacher profile" loading="lazy" width="1024" height="1536"><span>${extraCopy('AI demo photo','AI डेमो फोटो')}</span></div><div class="teacher-card-body"><p class="extra-kicker">${extraCopy('Fictional demo profile','काल्पनिक डेमो प्रोफाइल')}</p><h3 class="teacher-name">Meera Singh</h3><p>${extraCopy('Academic Support · Demo','शैक्षणिक सहयोग · डेमो')}</p><dl class="teacher-facts"><div><dt>${extraCopy('Teaching focus','शिक्षण का केंद्र')}</dt><dd>${extraCopy('Classes 8–10 · revision and guidance','कक्षा 8–10 · दोहराव और मार्गदर्शन')}</dd></div><div><dt>${extraCopy('Details','जानकारी')}</dt><dd>${extraCopy('Sample only · verification pending','केवल नमूना · सत्यापन बाकी')}</dd></div></dl><a class="extra-link" href="#admission">${extraCopy('Ask about classes →','कक्षाओं के बारे में पूछें →')}</a></div></article>
</div></div></section>
...
['.gallery-grid','.classes-grid','.career-paths','.approach-grid','.results-grid','.batch-grid','.resource-grid','.teacher-grid','.notice-list','.feedback-grid'].forEach(selector=>{
